...
def sell_paints():
    ...
    paints = [
        ...
        {
            'link': 'https://www.babetteclaassen.nl/kunstaanbod/renee-stotijn-rode-tulpen',
            'image-link': '/static/images/for_sale/Red-tulips-in-a-vase.-Ca.-1965.-Watercolor-on-paper.-Not-signed.-scaled.jpg',
        ...
        {
            'link': 'https://www.babetteclaassen.nl/kunstaanbod/renee-stotijn-vaas-met-roze-en-blauwe-bloemen',
            'image-link': '/static/images/for_sale/IMG_6941-scaled.jpg',
        ...
        {
            'link': 'https://www.babetteclaassen.nl/kunstaanbod/renee-stotijn-zicht-op-sint-bartholomeuskerk-schoonhoven',
            'image-link': '/static/images/for_sale/Bartholomeuskerk.png',
        ...
        {
            'link': 'https://www.babetteclaassen.nl/kunstaanbod/renee-stotijn-rode-bloemen-en-appels',
            'image-link': '/static/images/for_sale/IMG_6506-1-scaled.jpeg',
            'title': 'Rode bloemen en appels',
            'dimensions': 'N/A',
            'price': '€ 1200',
            'sold': True
        },
        ...
        {
            'link': None,
            'image-link': '/static/images/for_sale/3. Renée Stotijn - Rode tulpen in blauwe vaas.jpg',
            'title': 'Rode tulpen in blauwe vaas',
        ...
        {
            'link': None,
            'image-link': '/static/images/for_sale/5. Renée Stotijn - Stilleven met eierdopjes en flessen.jpg',
            'title': 'Stilleven met eierdopjes en flessen',
            'dimensions': '(42,2 cm x 54 cm)',
            'price': '€ 800',
            'sold': True
        },
        {
            'link': None,
            'image-link': '/static/images/for_sale/6. Renée Stotijn - Druiven en een appel in rood-groene tinten.jpg',
            'title': 'Druiven en een appel in rood-groene tinten',
            'dimensions': '(31,5 cm x 42 cm)',
            'price': '€ 600',
            'sold': True
        },
        {
            'link': None,
            'image-link': '/static/images/for_sale/7. Renée Stotijn - Twee vazen op een schaal.jpg',
            'title': ' Twee vazen op een schaal',
